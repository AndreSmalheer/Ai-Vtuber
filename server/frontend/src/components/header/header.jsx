...
function Header({
  ...
  const handleToggleOrbitControls = () => {
    const nextConfig = {
      ...config,
      orbit_controls_enabled: config.orbit_controls_enabled !== false ? false : true,
    };
    updateConfig(nextConfig);
  };
  ...
  return (
    <>
      ...
      >
        ...
        {callBtn && !backBtn && (
          <button className="hamburger-manue-btn" onClick={handleToggleMenu}>
            <svg
              width="46"
              height="35"
              viewBox="0 0 46 35"
            ...
            <div className="menu-content" onClick={(e) => e.stopPropagation()}>
              ...
              <button className="menu-item" onClick={handleToggleOrbitControls}>
                <div
                  className="menu-item-icon"
                  style={{
                    color: config.orbit_controls_enabled !== false ? "var(--theme-active)" : "inherit",
                  }}
                >
                  <svg
                    viewBox="0 0 751 751"
